...
cur.execute('''
CREATE TABLE Tweets (tweet_id INTEGER, author TEXT, time_posted TIMESTAMP, tweet_text TEXT, retweets NUMBER)''')
...
for tweets in umsi_tweets['statuses']:
